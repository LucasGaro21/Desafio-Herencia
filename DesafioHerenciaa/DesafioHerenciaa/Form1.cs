...
namespace Inmueble_forms
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            // textTipoInmueble
            // 
            this.textTipoInmueble.BackColor = System.Drawing.Color.Gainsboro;
            ...
            this.textTipoInmueble.Cursor = System.Windows.Forms.Cursors.IBeam;
            ...
            // 
            this.texoCalcularPrecioFinal.BackColor = System.Drawing.Color.Coral;
        ...
        private void texoCalcularPrecioFinal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    int precioBasePiso = Convert.ToInt32(precioBase.Text);
                    int numeroPiso = Convert.ToInt32(pisos.Text);
                    int antiguedadPiso = Convert.ToInt32(antiguedad.Text);

                    String direccionPiso = direccion.Text;
            ...
            try
            {
                ...
                {
                    int antiguedadLocal = Convert.ToInt32(antiguedad.Text);
                    int precioBaseLocal = Convert.ToInt32(precioBase.Text);
                    int metros = Convert.ToInt32(superficie.Text);
                    int nroVentanas = Convert.ToInt32(ventanas.Text);
                    String direccionLocal = direccion.Text;
